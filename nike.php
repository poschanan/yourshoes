                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="pictures/nike-banner.jpg" alt="" style="height: 150px">
                                </div>                                                            
                            </div>                            
                        </div>
                    </div>
...
_END;
  ...
  $query = "select ProductName,Price,Picture from products where ProductName like 'Nike%'";
